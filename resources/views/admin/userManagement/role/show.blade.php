        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Name" value="{{(isset($data) ? $data->name : old('name'))}}">
                    @error('name')
                                    ...
                                    <fieldset class="reset-this redo-fieldset">
                                        ...
                                        @foreach ($mod['permissions'] as $perm)
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="permission_arr[]" value="{{$perm}}"  onclick="return false" @if(in_array($perm, $roles_perms_arr)) checked @endif>
