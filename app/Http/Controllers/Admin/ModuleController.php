...
class ModuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $seoData = [
            ...
            'seoable_type' => Module::class,//Model
            'details'=>[
                'SEOMeta'=>[
                    'title'=>$request->input('name'),//Meta title
                    'description'=>'This is my page description',//Meta description
                    'canonical'=>'',//Canonical link
                    'addMeta'=>[
                        "article:published_time"=> $record->created_at->toW3CString(),
                        "article:section"=> '',
                    ],
                    'keywords'=>['module','new-module'] //Keywords
                ],
                'OpenGraph'=>[
                    'title'=>$request->input('name'),//Open graph title
                    'description'=>'This is my page description',//Open graph description
                    'url'=>route('admin.module.show', $record->id),//Open graph url
                    'properties'=> [
                        'type'=>'',//Open graph type
                        'locale'=>'en-us'//Open graph language
                    ],
                    'image'=>[
                        'cover_image'=>'', //Open graph image url
                    ]
                ],
                'TwitterCard'=>[
                    'title'=>$request->input('name'),//Twitter title
                    'site'=>route('admin.module.show', $record->id),//
                ],
                'JsonLd'=>[
